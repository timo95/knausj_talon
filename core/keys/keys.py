...
def setup_default_alphabet():
    ...
    initial_default_alphabet = "arch beat cap delta each fine gust harp sit jury crunch look made near oscar pit quebec red sun trap urge vest whale plex yank zip aegis earth uber signage".split()
    initial_letters_string = "abcdefghijklmnopqrstuvwxyzäöüß"
